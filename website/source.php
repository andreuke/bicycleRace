    ...
    <div class="container">
      <div class="row">
        <div class="page-header">
          <h1>Source <small>How to run the app?</small></h1>
        </div>
        <div class="col-md-8">
          <p>The app was meant to run on the last version of Chrome and has not been tested on any other browser.</p>
          <p>To run the application a localweb server and a database server are needed.</p>
        ...
        <div class="col-md-4">
            <ul class="list-group">
              ...
              <li class="list-group-item"><a href="resources/app.zip">Source</a></li>
      ...
      <div class="row">
        <div class="page-header">
          <h1>Source <small>How to import the database?</small></h1>
        </div>
        <div class="col-md-12">
